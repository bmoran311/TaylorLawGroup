      ...
      <div class="header-bottom inner-page-ban">
        <div class="banner-wrap">
          ...
          <div class="banner-contents">
            <div class="container">
              <div class="banner-details practice-ban">
                <div class="row">
                  <div class="col-md-12 col-lg-7 col-12 col-sm-12">
                    <div class="banner-info">
                      <h4>Our Services</h4>
                      <h1>Paractice Areas</h1>
                    </div>
                  </div>
                  <div class="col-md-12 col-lg-5 col-12 col-sm-12">
                    <div class="banner-info practice-ban">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas ac</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="holder">
      ...
      <div class="tab-content-section">
        ...
        <div class="container">
                                ...
                                <div class="accordion-item">
                                  <h2 class="accordion-header" id="flush-heading11">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse11" aria-expanded="false" aria-controls="flush-collapse11">
                                         Litigation and Dispute Resolutio
                                    </button>
                                  </h2>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12 col-lg-6">
                                <div class="accordion-item">
                                  ...
                                  <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlush">
                                    <div class="accordion-body">LogAnalyzerGPT uses sophisticated GPT-based algorithms to read and analyze the contents of your log files. It identifies patterns, anomalies, and provides comprehensive reports based on the file data.</div>
                                  </div>
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12 col-lg-6">
                                <div class="accordion-item">
                                  <h2 class="accordion-header" id="flush-headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                                      Lorem ipsum dolor si M&A Litigation
                                    </button>
                                  </h2>
                                  <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlush">
                                    <div class="accordion-body">LogAnalyzerGPT uses sophisticated GPT-based algorithms to read and analyze the contents of your log files. It identifies patterns, anomalies, and provides comprehensive reports based on the file data.</div>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-lg-6">
                                <div class="accordion-item">
                                  <h2 class="accordion-header" id="flush-headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                         Lorem ipsum dolor si Alston Discovery
                                    </button>
                                  </h2>
                                  <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlush">
                                    <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
          ...
          <div class="practice-details-wrap">
            <ul class="list-unstyled">
              <li class=""><a href="#">Life Sciences </a></li>
              <li class=""><a href="#">Cell and Gene Therapy </a></li>
              <li class=""><a href="#">Dietary Supplements and Food Regulation</a></li>
              <li class=""><a href="#">Life Sciences Litigation</a></li>
              <li class=""><a href="#">Life Sciences Policy, Government Relations and Regulatory Compliance</a></li>
              <li class=""> <a href="#"> Life Sciences Transactions </a></li>
              <li class=""><a href="#">Medical Devices </a></li>
              <li class=""><a href="#"> Pharmaceuticals and Biotechnology</a></li>
              <li class=""><a href="#">Product Liability Life Sciences</a></li>
            </ul>
          </div>
        </div>
      </div>

      <div class="practice-details-section">
        <div class="container">
        </div>
      </div>
