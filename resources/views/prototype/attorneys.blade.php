...
<body>
  <header>
    <div class="header-top d-lg-none d-sm-block d-block d-md-block">
      <div class="mainmenu">
        <nav class="navbar">
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a class="nav-link" aria-current="page" href="index.html">Our Firm </a>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="attorneys.html" id="navbarDropdown" role="button"
                      aria-expanded="false">
                      Attorneys
                  </a>
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="#">Sub menu1</a></li>
                      <li><a class="dropdown-item" href="#">Sub menu2</a></li>
                  </ul>
                  </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="paractice-areas" id="navbarDropdown" role="button"
                      aria-expanded="false">
                      Practice Areas
                  </a>
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
      ...
      <div class="header-top d-lg-block d-md-none d-sm-none d-none">
        <div class="container">
          <div class="header-call-timg">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="header-clock-cont text-center">
                  <ul class="list-unstyled d-inline-flex d-flex">
                    <li><a href="tel: 843.723.2000"><i class="fa-solid fa-phone"></i></a></li>
                    <li><h4>Call Us Now <span> 843.723.2000</span></h4>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <nav class="navbar navbar-expand-md">
                <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.html">Our Firm </a>
                      </li>
                      <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="attorneys.html" id="navbarDropdown" role="button"
                            aria-expanded="false">
                      ...
                      <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="paractice-areas.html" id="navbarDropdown" role="button"
                            aria-expanded="false">
                            Practice Areas
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
      ...
      <div class="industry-section">
        ...
        <div class="container">
          <div class="about-wrap heading">
            <div class=row>
              ...
              <div class="col-md-12 col-lg-6 ">
                <div class="about-content heading">
                  <h4>An industry-leading patent<br> litigation powerhouse.</h4>
                  <p>labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse</p>
                   <p>Aillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit volupta</p>
            ...
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. vatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. </p>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-md-12 col-lg-6">
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                ...
                <!--   <div class="accordion-item">
                    ...
                    <div id="flush-collapsefive" class="accordion-collapse collapse" aria-labelledby="flush-headingfive" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">To use LogAnalyzerGPT, simply provide your log file in the supported format by attaching it to the ‘analyze’ form. Our tool will analyze the file and provide you with a detailed report in a matter of minutes or seconds depending on the file size.</div>
                    </div>
                  </div> -->
                  <div class="accordion-item bor-box-faq">
                  ...
                  <div class="accordion-item bor-box-faq">
                    <h2 class="accordion-header" id="flush-headingeight">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseight" aria-expanded="false" aria-controls="flush-collapseight">
                              Class Action & Multidistrict Litigation
                      </button>
                    </h2>
                    <div id="flush-collapseight" class="accordion-collapse collapse" aria-labelledby="flush-headingeight" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingeleven">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapselven" aria-expanded="false" aria-controls="flush-collapselven">
                        Construction
                      </button>
                    </h2>
                    <div id="flush-collapselven" class="accordion-collapse collapse" aria-labelledby="flush-headingeleven" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
                    </div>
                  </div>
                ...
                <div class="col-md-12 col-lg-6">
                  ...
                  <div class="accordion-item bor-box-faq">
                    <h2 class="accordion-header" id="flush-headings17">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapses17" aria-expanded="false" aria-controls="flush-collapses17">
                             Food, Beverage & Agribusiness
                      </button>
                    </h2>
                    <div id="flush-collapses17" class="accordion-collapse collapse" aria-labelledby="flush-headings17" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
                    </div>
                  </div>
                  <div class="accordion-item bor-box-faq">
                    <h2 class="accordion-header" id="flush-heading18">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collaps18" aria-expanded="false" aria-controls="flush-collaps18">
                             Government Contracts
                      </button>
                    </h2>
                    <div id="flush-collaps18" class="accordion-collapse collapse" aria-labelledby="flush-heading18" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse19" class="accordion-collapse collapse" aria-labelledby="flush-heading19" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse20" class="accordion-collapse collapse" aria-labelledby="flush-heading20" data-bs-parent="#accordionFlush">
                      <div class="accordion-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. </div>
                    </div>
                  </div>
                ...
                <div class="contact-form">
                  ...
                  <form>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <input type="email" class="form-control email-txt" placeholder="Email Address">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <input type="num" class="form-control phone-tex" placeholder="Phone">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <input type="text" class="form-control company-txt" placeholder="Company">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <textarea class="form-control message-txt" rows="3" placeholder="Message"></textarea>
                        </div>
                      </div>
                      <div class="cont-btn head">
                        <a href="#">SEND MESSAGE <i class="fa-solid fa-arrow-right"></i></a>
                      </div>
                    </div>
                  </form>
                </div>
            ...
            <div class="col-lg-3 col-md-12 col-sm-12">
              <div class="footer-menu menu-1">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><a href="paractice-areas.html">Practice Areas </a></li>
              ...
              <div class="footer-menu menu-3">
                <h4>get in touch</h4>
                 ...
                 <ul class="list-unstyled d-inline-flex d-flex">
                  ...
                  <ul class="list-unstyled d-inline-flex d-flex">
                    <li><a href="mailto:info@taylorlaw.com"><i class="fa-solid fa-envelope"></i></a></li>
                    <li><a href="mailto:info@taylorlaw.com"><span>info@taylorlaw.com</span></a>
                    </li>
                  </ul>
              </div>
            </div>
