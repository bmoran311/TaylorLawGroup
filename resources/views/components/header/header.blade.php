...
$bios = DB::table('bio')->where('type', 'LIKE', '%Attorney%')->orderBy('sort_order', 'asc')->get();

$leaders = DB::table('bio')->where('type', 'LIKE', '%Leadership%')->orderBy('sort_order', 'asc')->get();
                ...
                <div class="col-md-6">
                    <div class="header-clock-cont text-end">
                        <ul class="list-unstyled d-inline-flex d-flex">
                            ...
                            <li>
                                <h4>Call Us <span> 843.723.2000</span></h4>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="/attorneys?type=Attorney"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        @foreach ($bios as $bio)
                                            <li><a class="dropdown-item"
                                                    href="/attorney-detail/{{ $bio->id }}">{{ $bio->first_name }}
                                                    {{ $bio->last_name }}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="/practice-areas" id="navbarDropdown"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        @foreach ($practice_areas as $practice_area)
                                            <li><a class="dropdown-item"
                                                    href="/practice-area/{{ $practice_area->id }}">{{ $practice_area->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="nav-item logo-t">
                                    <a class="nav-link" href="/"><img src="/site/img/logo1.png" class="img-fluid"
                                            alt="logo" /></a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="/attorneys?type=Leadership"
                                        id="navbarDropdown" role="button" aria-expanded="false">
                                        Leadership
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="/our-firm" id="navbarDropdown"
                                        role="button" aria-expanded="false">
                                        Culture
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="/testimonials?type=Customer Service">Customer
                                                Service</a></li>
                                        <li><a class="dropdown-item" href="/testimonials?type=Experience">Experience</a>
                                        </li>
                                        <li><a class="dropdown-item" href="/testimonials?type=Commitment">Commitment</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
